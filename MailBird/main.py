...
from utilities import ColorUtils, DisplayUtils
...
class EmailSender:
    def __init__(self):
        ...
        self.MAILS_DIR = 'mails'
        self.BANNER_PATH = '../banner/mailbird.txt'
    ...
    def list_templates(self):
        ...
        if not templates_dir.exists():
            print(f"{self.colors.RED}[-] Templates directory not found.{self.colors.RESET}")
            return []
